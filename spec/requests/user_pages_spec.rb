...
=begin		
		before do
			...
			FactoryGirl.create(:user, name: "Benchik", email: "benchik@ex.com")
			FactoryGirl.create(:user, name: "Telemachus", email: "telemachus@ex.com")
			visit users_path
		end
...
# 			These all work, but the tests don't.			
